    ...
    public static void main(String[] args) {
        try {
            ...
            while (arrayLength < 0 || arrayLength > 10) {
                System.out.println("10 is the max, try again!");
            ...
            while (true) {
                ...
                if (user == 1) {
                    method.mergeSort(array, 0, arrayLength - 1);
                    method.print();
                } else if (user == 2) {
                    System.out.println("Enter the number you want to search for: ");
                    int search = scanner.nextInt();
                    method.mergeSort(array, 0, arrayLength - 1);
                    method.binarySearch(array, arrayLength, search);
                } else if (user == 3) {
            ...
            System.out.println("ENTER MORE THAN 0 INTEGERS!!! \nSYSTEM IS EXITING!!!");
            System.exit(0);
        }
    }
}
